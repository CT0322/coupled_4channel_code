#!/bin/bash
data_dir=/hiskp2/tingchen/DDscattering/data/A40.24/charm_2911
conf=1322
# Set start value of node number
nodenum=2
while [ $conf -le 1598 ]
 do
   while [ `qstat -u tingchen | grep tingchen | wc -l` -gt 8 ]; do echo "queue is full"; sleep 30; done
